...
export default function PrivacyPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#031B17] font-['Montserrat'] text-white">
      <Seo
        title="Politique Confidentialité | Aymen Promotion"
        description="Politique de protection des données d'Aymen Promotion : collecte, traitement, droits RGPD, cookies et sécurité de vos informations personnelles."
        keywords="promoteur immobilier alger, aymen promotion, politique confidentialite, rgpd"
