...
export default function ConcoursBatitecEnoncePage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#031B17] font-['Montserrat'] text-white overflow-x-hidden">
      <Seo
        title={`Concours Batitec — Énoncé ${getCategoryLabel(category)}`}
        description={`Téléchargez l'énoncé du Concours Batitec catégorie ${getCategoryLabel(category)} et participez à l'innovation architecturale en Algérie.`}
        keywords="concours batitec, aymen promotion, architecte alger, innovation btp"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-3 rounded-3xl border border-white/10 bg-[#0C2A24]/75 backdrop-blur-md shadow-2xl p-6 md:p-10">
              <div className="mb-6 rounded-2xl border border-[#F7C66A]/25 bg-[#031B17]/35 px-5 py-4 text-sm text-white/80">
                ...
                avant le dernier délai fixé le : <span className="text-[#F7C66A] font-bold">21-06-2026</span>
              </div>
              {category === "hotel" ? (
